              ...
              <div class="col-lg-6">
				...
				<img src="https://www.sunny.pet/wp-content/uploads/2017/03/casa-azul.png" style="width:3rem"></a>
                  ...
                  <form class="user" method="post" action="/accedi">
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="psswrd" placeholder="Password" required>
                    </div>
                    <div class="form-group">
                    ...
                    <input id="login" type="submit" value="Login" class="btn btn-primary btn-user btn-block">
                  </form>
                  <hr>
                  <div class="text-center">
