...
/**
* <h1>Controller Schedina</h1>
* 
* <p>
* Controller che si occupa di tutte le operazioni relative alla formazione e la valutazione della
* scommessa.
* </p>
*
*
...
public class ControllerSchedina {
	...
	/**
	   * Conferma e invio della schedina effettuata. Il metodo crea la sintesi della schedina
	   * da aggiungere al riepilogo e inserisce in sessione la copia della schedina necessaria
	   * per il controllo dell'esito, entrambi vengono identificati da una chiave generata iterativamente
	   * 
	   * @return redirect a riepilogo
	   */
	...
	/**
	   * Valutazione della schedina effettuata. Il metodo controlla l'esito delle partite selezionate
	   * accedendo al database e a seconda del risultato fissa l'esito della schedina totale "Vincente" o "Perdente"
	   * @param codice chiave della schedina selezionata
	   * @return redirect a riepilogo
	   */
	...
	public String risultati(Model model, HttpSession session,
		...
		if(esitoTot) {
			...
			double bs = sf.getVincita() - sf.getImporto();
			sf.setBilancio(bs);
			sfs.save(sf);
...
//		Schedina s = new Schedina();
	...
	/**
	   * Annullamento della scommessa selezionata. Il metodo rimuove la scommessa precedentemente
	   * confermata e aggiorna il saldo e il bilancio dell'utente di conseguenza
	   * @param codice chiave della schedina selezionata
	   * @return redirect a riepilogo
	   */
	...
	/**
	   * Il metodo rimuove un evento dalla schedina in corso (non ancora confermata) e aggiorna la quota totale
	   * @param idPartita id della partita
	   * @param tipo tipo di partita (calcio, basket o hockey)
	   * @param pagina pagina alla quale reindirizzare (calcio, basket o hockey)
	   * @return redirect alla pagina corrente
	   */
	...
	/**
	   * Calcola la vincita potenziale moltiplicando la quota totale per l'importo inserito in input
	   */
	...
	/**
	   * Il metodo aggiunge un evento alla schedina in corso (non ancora confermata)
	   * inserendo le caratteristiche dell'evento, la quota selezionata ("H", "X" o "A") e il valore della quota.
	   * L'evento viene aggiunto alla schedina (presa dalla sessione se già ne esiste una in corso) che viene reinserita in sessione 
	   * @param idPartita id della partita
	   * @param tipo tipo di partita (calcio, basket o hockey)
	   * @param quotaSel la quota selezionata (H, X o A)
	   * @return redirect alla pagina corrente
	   */
